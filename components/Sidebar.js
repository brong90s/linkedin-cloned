  ...
  return (
    <div className="space-y-2 min-w-max max-w-lg">
      ...
      <div className="bg-white dark:bg-[#1D2226] rounded-lg overflow-hidden relative flex flex-col items-center text-center border border-gray-300 dark:border-none">
        ...
        <Avatar
          src="https://avatars.githubusercontent.com/u/89784728?v=4"
        ...
        <div className="hidden md:inline text-left dark:text-white/75 text-sm">
          <div className="font-medium sidebarButton space-y-0.5">
            <div className="flex justify-between space-x-2">
              ...
              <span className="text-bue-500">343</span>
            </div>
            <div className="flex justify-between space-x-2">
              <h4>Views your post</h4>
              <span className="text-blue-500">1,848</span>
            </div>
          </div>
      ...
      {/* BOTTOM */}
      <div className="hidden md:flex flex-col space-y-2 pt-2.5 sticky top-20 bg-white dark:bg-[#1D2226] text-black/70 dark:text-white-75 rounded-lg overflow-hidden border border-gray-300 dark:border-none">
