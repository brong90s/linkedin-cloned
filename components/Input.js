...
const Input = () => {
  ...
  return (
    <div className="p-3 space-y-3 bg-white dark:bg-[#1D2226] rounded-lg border border-gray-300 dark:border-none">
      <div className="flex items-center space-x-2">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.99 }}
          className="w-full py-2.5 px-3 text-left rounded-full border border-gray-400 opacity-80 hover:opacity-100 font-medium"
          onClick={() => {
            setModalOpen(true)
            setModalType("dropIn")
          }}
